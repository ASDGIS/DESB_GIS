...
var styleCache_SOSYALALANLAR5={}
var style_SOSYALALANLAR5 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    if (!styleCache_SOSYALALANLAR5[key]){
        ...
        styleCache_SOSYALALANLAR5[key] = new ol.style.Style({"text": text})
    }
    var allStyles = [styleCache_SOSYALALANLAR5[key]];
