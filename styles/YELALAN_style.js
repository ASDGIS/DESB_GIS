...
var styleCache_YELALAN={}
var style_YELALAN = function(feature, resolution){
    var value = ""
    var size = 0;
    ...
    if (!styleCache_YELALAN[key]){
        ...
        styleCache_YELALAN[key] = new ol.style.Style({"text": text})
    }
    var allStyles = [styleCache_YELALAN[key]];
