...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [386505.751944, 4553839.118298, 388444.823372, 4556146.978508], maxZoom: 28, minZoom: 1, projection: 'USER:100001'
    })
});
...
map.getView().fit([386505.751944, 4553839.118298, 388444.823372, 4556146.978508], map.getSize());
