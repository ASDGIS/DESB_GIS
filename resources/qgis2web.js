...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [3189168.257620, 5028806.025056, 3191690.845965, 5031915.748437], maxZoom: 28, minZoom: 1
    })
});

map.getView().fit([3189168.257620, 5028806.025056, 3191690.845965, 5031915.748437], map.getSize());
